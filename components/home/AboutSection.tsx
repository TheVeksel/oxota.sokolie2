      ...
      <div className="grid gap-8 lg:grid-cols-[1.05fr_0.95fr] lg:items-center">
        <div>
          ...
          <p className="mt-6 max-w-xl text-base leading-7 text-white/68">
            В основе проекта спокойные утренние часы, глубокий лес,
            качественный сервис и ощущение уединения. Каждая деталь продумана
            так, чтобы пространство выглядело современно, дорого и по-настоящему
            уютно.
          </p>
